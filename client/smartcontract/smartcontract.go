...
import (
	...
	password "github.com/icloudland/starchain/common/passwd"
	"github.com/icloudland/starchain/core/code"
	...
	httpjsonrpc "github.com/icloudland/starchain/net/rpchttp"
...
func makeDeployContractTransaction(signer *account.Account, codeStr string, language int) (string, error) {
	...
	tx, err := transaction.NewDeployTransaction(fc, signer.ProgramHash, "STC", "1.0", "STC user", "user@STCChain.com", "test uint", types.LangType(byte(language)))
	if err != nil {
...
func contractAction(c *cli.Context) error {
	...
	resp, err := httpjsonrpc.Call(client.Address(), "sendrawtransaction", 0, []interface{}{txHex})
	if err != nil {
...
func NewCommand() *cli.Command {
	return &cli.Command{
		...
		OnUsageError: func(c *cli.Context, err error, isSubcommand bool) error {
			client.PrintError(c, err, "smartcontract")

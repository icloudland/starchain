...
import (
	...
	. "github.com/icloudland/starchain/vm/avm/errors"
)
...
func (is *InteropService) Register(methoSTCme string, handler func(*ExecutionEngine) (bool, error)) bool {
	if _, ok := is.serviceMap[methoSTCme]; ok {
		return false
	}
	is.serviceMap[methoSTCme] = handler
	return true
}

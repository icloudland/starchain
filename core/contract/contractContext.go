...
import (
	...
	pg "github.com/icloudland/starchain/core/contract/program"
	sig "github.com/icloudland/starchain/core/signature"
	"github.com/icloudland/starchain/crypto"
	_ "github.com/icloudland/starchain/errors"
	"errors"
	"math/big"
	"sort"
)
...
func NewContractContextExt(data sig.SignableData) *ContractContext {
	programHashes, _ := data.GetProgramHashes() //TODO: check error
	hashLen := len(programHashes)
	return &ContractContext{
		Data:            data,
